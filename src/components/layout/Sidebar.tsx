...
const Sidebar: React.FC<SidebarProps> = ({ collapsed, onToggleCollapse, currentFolderId, onFolderSelect, onNavigate, onImagesChanged, refreshTrigger: externalRefreshTrigger = 0, systemLanguage }) => {
  ...
  const handleCreateFolder = () => {
    setIsCreating(true);
    setNewFolderName(t['sidebar.newFolderDefault']);
        ...
        >
          ...
          {showFolderPopup && (
            <div
              ...
              onMouseLeave={handleFolderMouseLeave}
            >
              <h3 className="px-2 mb-1 text-xs font-semibold text-stone-400 uppercase">{t['sidebar.folders']}</h3>
              <FolderTree
  ...
  return (
    <div className="flex flex-col h-full bg-cream dark:bg-stone-900">
      ...
      <div className="flex-1 overflow-y-auto px-2 py-2 space-y-4">
        {/* Library Section */}
        <div>
          <h2 className="px-3 mb-1 text-xs font-semibold text-stone-400 dark:text-stone-500 uppercase tracking-wider">{t['sidebar.library']}</h2>
        ...
        <div>
          <div className="flex items-center justify-between px-3 mb-1">
            <h2 className="text-xs font-semibold text-stone-400 dark:text-stone-500 uppercase tracking-wider">{t['sidebar.folders']}</h2>
            <button
        ...
        <div>
          <h2 className="px-3 mb-1 text-xs font-semibold text-stone-400 dark:text-stone-500 uppercase tracking-wider">{t['sidebar.tools']}</h2>
          <div className="space-y-0.5">
            <button
              onClick={() => onNavigate?.('printer')}
            ...
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" /></svg>
              <span>{t['sidebar.stylePrinter']}</span>
            </button>
          </div>
        </div>
      </div>
