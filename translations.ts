...
export const translations = {
  ...
  Spanish: {
    ...
    uploadClickBrowse: "o haz clic para buscar",
  ...
  French: {
    ...
    uploadClickBrowse: "ou cliquez pour parcourir",
  ...
  German: {
    ...
    uploadClickBrowse: "oder klicken zum Durchsuchen",
  ...
  Korean: {
    ...
    uploadDropHere: "여기에 이미지 드롭",
    uploadDropIt: "드롭!",
    uploadClickBrowse: "또는 클릭하여 찾아보기",
